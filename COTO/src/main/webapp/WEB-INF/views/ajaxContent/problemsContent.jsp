...
<div class="table">
	<div class="tableRow">
		...
		<span class="tableCell th2">메모</span>
...
$(document).ready(function() {
	...
	$(document).off("click").on("click", ".editBtn", function(){
		...
		$(editCell[6]).html('<button id="cancelbtn" type="button"><i class="fas fa-times"/></i></button><button onclick="updateAjax()" type="button"><i class="fas fa-pen"></i></button>');
	});
