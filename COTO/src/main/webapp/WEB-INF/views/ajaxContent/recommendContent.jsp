...
<div class="tableRow">
	...
	<span class="tableCell th3">제목</span>
	<span class="tableCell th2">등록자</span> 
	<span class="tableCell th1">난이도</span>
	<span class="like-col tableCell th1">추천수</span> 
	<span class="comment-col tableCell th1">댓글수</span>
	<span class="tableCell th1">등록일</span>
</div>

<c:forEach items="${recoms}" var="recoms" varStatus="status">
<fmt:formatDate value="${recoms.regDate}" var="formattedDate" type="date" pattern="yyyy-MM-dd" />
	...
	<div class="tableRow" id="recoms${recoms.id}" onclick="printAllContent('#recoms${recoms.id}', ${recoms.id}, ${recoms.recomCommentCount})">
		...
		<span class="tableCell td3 alignCenter readTitle">${recoms.title}</span> 
		...
		<span class="tableCell td1 alignCenter">${formattedDate}</span>
