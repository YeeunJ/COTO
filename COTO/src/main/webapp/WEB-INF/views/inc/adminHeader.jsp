		...
		<div class = "nav-wrapper">
			...
			<ul class = "hide-on-med-and-down mymenu">
				...
				<li id = "list"><span id = "listspan" onclick="location.href='./usermanage'">사이트 관리<i class="material-icons right">arrow_drop_down</i></span>
					<ul class = "submenu">
						<li id = "list" onclick="location.href='./usermanage'"><span id = "listspan">사용자 관리</span></li>
						<li id = "list" onclick="location.href='./manageCodingsite'"><span id = "listspan">코딩 사이트 관리</span></li>
					</ul>
				</li>				
				<li class = "right">
